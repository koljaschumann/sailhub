    ...
    <div className="space-y-6">
      <div>
        ...
        <p className={isDark ? 'text-cream/60' : 'text-light-muted'}>
          Startgeld-Erstattungen verwalten
        </p>
      </div>
      ...
      <GlassCard>
        <div className="text-center py-8">
          <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
            ...
            <span className={`w-8 h-8 ${isDark ? 'text-emerald-400' : 'text-emerald-600'}`}>
              {Icons.settings}
            </span>
          </div>
          <h2 className={`text-xl font-bold mb-2 ${isDark ? 'text-cream' : 'text-light-text'}`}>
          ...
          <p className={`mb-4 ${isDark ? 'text-cream/60' : 'text-light-muted'}`}>
            Hier kannst du alle Startgeld-Erstattungen einsehen und verwalten.
          </p>
